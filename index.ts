...
import { Cola, ColaReducer, ChildrenComponents, header, bundle, doNotUseLayout, pagePros } from './src/decorators/views';
...
exports.Decorators = {
  ...
  view: { ...reduxConnect, 
    ...
    include: ChildrenComponents, header, bundle, doNotUseLayout, pagePros }
};
